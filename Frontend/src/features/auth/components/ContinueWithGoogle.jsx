const ContinueWithGoogle = () => {
    return (
        ...
        >
            <span className="absolute inset-0 opacity-0 transition-opacity duration-200 group-hover:opacity-[0.08] bg-[#303030]" />
            <div className="mr-2 flex h-5 w-5 min-w-5 items-center justify-center">
